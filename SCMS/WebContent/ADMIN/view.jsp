    ...
    <div id="site_content">  
      ...
      <div id="nav">
    	...
    	<div id="top_nav" class="ddsmoothmenu">   
            <ul>
                <li><a href="/SCMS/ADMIN/home.jsp" class="selected">Home</a></li>
                <li><a href="#">Staff</a>
                	<ul>
                    ...
                    <tr>
                        <s:iterator value="list">
								<tr>
									...
									<td><a href="editstaff?staff_id=<s:property value="staff_id" />"
									style="background:#3A6F39;
									border:none;
									color:#fff;
									padding: 5px 10px;
									cursor:pointer; ">Edit</a></td>
									<td><a href="deletestaff?staff_id=<s:property value="staff_id"/>"
									style="background:#3A6F39;
									border:none;
									color:#fff;
									padding: 5px 10px;
