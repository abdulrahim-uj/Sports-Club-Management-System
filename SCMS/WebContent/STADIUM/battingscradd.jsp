...
<%--  <%
	...
	Connection con3 = new Dbcon().getConnection();
	String query3 = "select distinct playername from team join player where team.ownername=player.ownername";
	Statement stmt3 = con3.createStatement();
	ResultSet rs3 = stmt3.executeQuery(query3);
%> 
 --%>    
  ...
  <div id="main">
    <div id="site_content">  
      ...
      <div id="nav">
	   ...
	   <form action="batscr" class="register">
            <h1>Add Batting Score Sheet</h1>
        ...
        <table cellspacing="5">
             ...
             <td>
          	...
          	<td>
		  	<divp><input class="contact" type="text" name="mname" value="<s:property value = "mname"/>" /></p></div>
		  	</td>
		</tr>
	    	<td>
          	...
          	<td>
		  	<div><p><select id="tname" name="tname"  ><%
												while (rs1.next()) {
											%>
											<option value="">
	    ...
	    <tr>
	    	...
	    	<td>
	    		<div><p><input class="team" type="text" id="player" name="pname" value="" /></p></div>
	    	</td>
	    </tr>
	    <tr>
	    	<td>
	    		<div style="width:170px; float:left;"><p>Mode Of Dismissal</p></div>
	    	</td>
	    	<td>
	    		<div><p><input class="team" type="text" name="mdismis" value="" /></p></div>
	    	</td>
	    </tr>
	    <tr>
	    	<td>
	    		<div style="width:170px; float:left;"><p>Bowler</p></div>
	    	</td>
	    	<td>
	    		<div><p><input class="team" type="text" name="bowler" value="" /></p></div>
	    	</td>
	    </tr>
	    <tr>
	    	<td>
	    		<div style="width:170px; float:left;"><p>Run Taked</p></div>
	    	</td>
	    	<td>
	    		<div><p><input class="team" type="text" name="run" value="" /></p></div>
	    	</td>
	    </tr>
	     </table>
        ...
        <!--close content_item-->
				...
				/*	alert("df")  */
							...
							<table border=1 align="left" valign=center style="width: 150px;">
								...
								<tr>
									<td><h2>PLAYER NAMES<input type="text" name="tname" id="tname"  /></h2></td>
								</tr>
								<tr>
