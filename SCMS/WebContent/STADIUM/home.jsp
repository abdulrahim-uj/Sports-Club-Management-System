...
<script>
	...
	<s:url id="ffff"></s:url>
  <title>SCMS Stadium Manager</title>
      ...
      <div id="content">
        <div class="content_item">
          <h1>Welcome to your website</h1>
         	...
         	<h5>Out door</h5>
         <h2>Specification</h2>
         <h5>Indoor, Outdoor Stadiums specification</h5>
         <h2>Events</h2>
         <h5>Featured</h5>
         <h5>Previous</h5>
		  ...
		  <div class="sidebar">
            <div class="sidebar_item">
              <h2>Latest Blog</h2>
		  	  <h4>April 2012</h4>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque cursus tempor enim.</p>
		        <a href="#">Read more</a><label style="font-size: large; color: maroon;">sdfjdsbgdsbjkds</label>
            </div><!--close sidebar_item--> 
          </div><!--close sidebar-->  
		  <div class="sidebar">
            <div class="sidebar_item">
