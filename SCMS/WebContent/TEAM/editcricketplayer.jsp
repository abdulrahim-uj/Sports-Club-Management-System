...
<script type="text/javascript">
    ...
    <script type="text/javascript">
            function specicopy()
            {
                var sel = document.getElementById('speci').value;
                
                document.getElementById('Specified').value = sel;
            }
        </script>
    ...
    <script type="text/javascript">
            function batposcopy()
            {
                var sel = document.getElementById('batpos').value;
                
                document.getElementById('Batposition').value = sel;
            }
        </script>
    ...
    <script type="text/javascript">
            function stylcopy()
            {
                var sel = document.getElementById('styl').value;
                
                document.getElementById('Style').value = sel;
            }
        </script>
    ...
    <script type="text/javascript">
            function hancopy()
            {
                var sel = document.getElementById('han').value;
                
                document.getElementById('Hand').value = sel;
            }
        </script>
        
    <script type="text/javascript">
            function bowlstylcopy()
            {
                var sel = document.getElementById('bowlstyl').value;
                
                document.getElementById('Bowlstyle').value = sel;
            }
        </script>
        
    <script type="text/javascript">
            function mentalitcopy()
            {
                var sel = document.getElementById('mentalit').value;
                
                document.getElementById('Mentality').value = sel;
            }
        </script>
    ...
    <script type="text/javascript">
            function fposcopy()
            {
                var sel = document.getElementById('fpos').value;
                
                document.getElementById('Fposition').value = sel;
            }
        </script>
    ...
    <div id="site_content">  
      <div id="header">  
       ...
       <div id="nav">
        ...
        <form action="updateplayer" class="register" method="post"
            ...
            <!--     <legend>Image
                ...
                <label>Player ID</label>
                	<input type="text" name="player_id" value='<s:property value="player_id"/>' />
            </fieldset>                        
            <fieldset class="row2">
                ...
                <p>
                    ...
                    <input type="text" name="pname" value='<s:property value="pname" />' />
                </p>
                <p>
                    <label>Address *
                    </label>
                    <textarea rows="5" cols="26" name="adrs"><s:property value = "adrs"/></textarea>
                </p>
                <p>
                	<label>Email_id *
                	</label>
                ...
                <p>
                    ...
                    <input type="text" class="10" name="ph" value='<s:property value="ph"/>'/>
                </p>
                <p>
                	<label>Country *
                	</label>
                	<input type="text" name="country" value='<s:property value="country"/>'/>
                </p>
            </fieldset>
            <fieldset class="row3">
                ...
                <p>
                    <label>Gender *</label> <input type="radio" name="gender" value='<s:property value="gender"/>' /> <label>
							class="gender">Male</label> <input type="radio" name="gender" value='<s:property value="gender"/>'/>
						<label class="gender">Female</label>
                </p>
                <p>
                     <label>DOB *
                    </label>
 	                    <input type="text"  name="dob" id="datepicker"  onchange="fage(this.value);" value='<s:property value="dob"/>'>
 	            </p>
            </fieldset>
            <fieldset class="row4">
            	...
            	<p>
            		...
            		<input type="text" name="specified" id="Specified" value='<s:property value = "specified"/>' readonly="readonly"/>
					<label><span>&nbsp Options &nbsp</span></label><select id="speci" name="speci" style="width:153px;">
                    ...
                    <input type="button" value="Select" name="btn_move" id="btn_move" style="background:#3A6F39;
									border:none;
									color:#fff;
									padding: 5px 10px;
									cursor:pointer; " onclick="specicopy()">
            	</p>
            	<p>
            		<label>Bat position</label>
            		<input type="text" name="batposition" id="Batposition" value='<s:property value = "batposition"/>' readonly="readonly">
					<label><span>&nbsp Options &nbsp</span></label><select id="batpos" name="batpos" style="width:153px;">
                        <option>--select--</option>
                    ...
                    <input type="button" value="Select" name="btn_move" id="btn_move" onclick="batposcopy()">
            	</p>
            	<p>
            		<label>Style</label>
            		<input type="text" name="style" id="Style" value='<s:property value = "style"/>' readonly="readonly">
					<label><span>&nbsp Options &nbsp</span></label><select id="styl" name="styl" style="width:153px;">
            			<option>--select--</option>
            			<option value="moderate">Moderate</option>
            			<option value="defensive">Defensive</option>
            			<option value="agresive">Aggressive</option>
            		</select>
            		<input type="button" value="Select" name="btn_move" id="btn_move" onclick="stylcopy()">
            	</p>
            	<p>
            		<label>Hand</label>
            		<input type="text" name="hand" id="Hand" value='<s:property value = "hand"/>' readonly="readonly">
					<label><span>&nbsp Options &nbsp</span></label><select id="han" name="han" style="width:153px;">
            			<option>--select--</option>
            			<option value="left">Left</option>
            			<option value="right">Right</option>
            		</select>
            		<input type="button" value="Select" name="btn_move" id="btn_move" onclick="hancopy()">
            	</p>
            	<p>
            		<label>Bowl Style</label>
            		<input type="text" name="bowlstyle" id="Bowlstyle" value='<s:property value = "bowlstyle"/>' readonly="readonly">
					<label><span>&nbsp Options &nbsp</span></label><select id="bowlstyl" name="bowlstyl" style="width:153px;">
            			<option>--select--</option>
            		...
            		<input type="button" value="Select" name="btn_move" id="btn_move" onclick="bowlstylcopy()">
            	</p>
            	<p>
            		<label>Mentality</label>
            		<input type="text" name="mentality" id="Mentality" value='<s:property value = "mentality"/>' readonly="readonly">
					<label><span>&nbsp Options &nbsp</span></label><select id="mentalit" name="mentalit" style="width:153px;">
            			<option>--select--</option>
            			<option value="agresive">Aggressive</option>
            			<option value="moderate">Moderate</option>
            			<option value="defensive">Defensive</option>
            		</select>
            		<input type="button" value="Select" name="btn_move" id="btn_move" onclick="mentalitcopy()">
            	</p>
            	<p>
            		<label>Field position</label>
            		<input type="text" name="fposition" id="Fposition" value='<s:property value = "fposition"/>' readonly="readonly">
					<label><span>&nbsp Options &nbsp</span></label><select id="fpos" name="fpos" style="width:153px;">
            			<option>--select--</option>
            		...
            		<input type="button" value="Select" name="btn_move" id="btn_move" onclick="fposcopy()">
            	</p>
            </fieldset>
            <fieldset class="row5">
