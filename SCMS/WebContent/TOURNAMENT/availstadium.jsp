...
<html>
<head>
  <title>SCMS Available Stadium</title>
      ...
      <div id="nav">
    	...
    	<div id="top_nav" class="ddsmoothmenu">   
            <ul>
                ...
                <li><a href="availablestadium">Free Stadiums</a></li>
                    ...
                    <tr>
                        <s:iterator value="list" >
								...
								<tr>
									...
									<td><a href="selectstadium?stadium_id=<s:property value="stadium_id" />&eve=<s:property value="eve"/>"
									style="background:#3A6F39;
									border:none;
									color:#fff;
									padding: 5px 10px;
									cursor:pointer; ">Select</a></td>
								</tr>
							</s:iterator>
