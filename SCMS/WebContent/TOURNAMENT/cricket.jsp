		...
		<div class="sidebar_container">
		  ...
		  <div class="sidebar">
           ...
           <marquee direction="up" onmouseover="this.stop()" onmouseout="this.start()">
                <h2><blink>Upcoming Events...</blink></h2>
                <s:iterator value="list">
                <p style="color: navy;">The Cricket event <label style="color: navy; font-weight: bold; font-style: italic;"><s:property value="ename"/></label> between <label style="color: teal; font-weight: bold; font-style: italic;"><s:property value="team"/></label><label style="color: orange; font-weight: bold;"> V/S </label>
                	<label style="color: teal; font-weight: bold; font-style: italic;"><s:property value="team1"/></label> will be
                	going on <label style="color: navy; font-weight: bold; font-style: italic;"><s:property value="date"/></label> at <label style="color: navy; font-weight: bold; font-style: italic;"><s:property value="sname"/></label></s:iterator></marquee>
