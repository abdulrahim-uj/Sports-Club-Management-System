    ...
    <div id="site_content">  
	  ...
	  <form action="Register" class="register">
				...
				<fieldset class="row1">
					...
					<p>
						<label>Email * </label> <input type="text" name="email" /> <label>Repeat
							email * </label> <input type="text" name="remail"/>
					</p>
					<p>
						<label>Password* </label> <input type="text" name="password"/> <label>Repeat Password* </label> <input type="text" name="repass"/> <label class="obinfo">*
				...
				<fieldset class="row2">
					...
					<p>
						<label>Name * </label> <input type="text" name="name" class="long" />
					</p>
					<p>
						<label>Address * </label>
						<textarea rows="5" cols="25" class="long" name="adrs"></textarea>
					</p>
					<p>
						<label>Phone * </label> <input type="text" name="mob" maxlength="10" />
					</p>
					<p>
						<label>City * </label> <input type="text" name="city" class="long" />
					</p>
					<p>
						<label>Country * </label> <input type="text" name="country" class="long" />
					</p>
					<p>
				...
				<fieldset class="row3">
					...
					<p>
						<label>DOB * </label> <input type="text" name="dob"
							id="datepicker" onchange="fage(this.value);">
</p>
					<p>
				...
				<fieldset class="row5">
					...
					<p>
						<label>Working * </label> <input type="text" class="long" name="des"/>
					</p>
					<p>
						<label>Activity * </label> <input type="text" class="long" name="activity"/>
					</p>
					<p>
